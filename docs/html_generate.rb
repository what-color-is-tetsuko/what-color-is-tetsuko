...
<head>
    ...
    <meta property="og:description" content="わたしは「#{nihon}柳徹子」でした" />
        ...
        <div id="app">
            <div class="resultBackground">
                <div class="resultContents">
                    ...
                    <div class="leftBox">
                        <h2 class="resultText"> #{n}問正解なので<br>あなたは「#{nihon}柳徹子」でした</h2>
                    </div>
                    <div class="leftBox">
                ...
                <div class="sns">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=わたしは #{n}問正解 でしたので「#{nihon}柳徹子」でした。%0A%0A%23黒柳テスト%0Ahttp://quiz.what-color-is-tetsuko.xyz/#{roma}.html"
                        target="_blank" title="Twitterでシェア"><img src="./assets/button_twitter.png" alt="twitter"></a>
                    <a href="http://line.me/R/msg/text/?わたしは #{n}問正解で%0A「#{nihon}柳徹子」でした%0A%0A黒柳テスト%0Ahttp://quiz.what-color-is-tetsuko.xyz/#{roma}.html" target="_blank"
